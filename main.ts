      ...
      return c.html(Layout("Admin", `
        <div class="grid lg:grid-cols-3 gap-8">
          ...
          <div class="lg:col-span-2 space-y-8">
            ...
            <input name="originalPrice" type="number" placeholder="Original Price (Optional - for Discount UI)" class="w-full bg-slate-800 border border-slate-600 rounded p-2 text-white">
            <input name="imageUrl" placeholder="Image URL (Optional)" class="w-full bg-slate-800 border border-slate-600 rounded p-2 text-white"><textarea name="data" placeholder="Codes (Manual) or URL (API)" class="w-full bg-slate-800 border border-slate-600 rounded p-2 text-white h-20"></textarea><button class="w-full bg-green-600 hover:bg-green-500 text-white font-bold py-2 rounded">Add Product</button></form></div>
